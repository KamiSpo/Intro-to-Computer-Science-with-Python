...
def updateHand(hand, word):
    ...
    for letter in word:
        if letter in hand.keys():
            current_hand[letter] = current_hand.get(letter, 0) - 1
    return current_hand
    ...
    while n != 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                total += word_score
                print(word + " earned " + str(word_score) + " points. Total: " + str(total) + " points. ")
                print()
                # Update the hand 
...
def playGame(wordList):
    ...
    while True:
        print()
        decision = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
        if decision == "n":
